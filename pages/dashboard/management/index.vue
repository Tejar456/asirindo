      ...
      <div class="-m-1.5 overflow-x-auto">
        <div class="p-1.5 min-w-full inline-block align-middle">
          ...
          >
            ...
            >
              <div>
                <h2 class="text-2xl font-semibold text-gray-800">Management Data</h2>
              </div>
              ...
              <div class="flex items-center gap-3">
                <NuxtLink
                  ...
                  to="/dashboard/management/create"
                >
                  <svg
            ...
            <div class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                  <tr
                    v-for="management in paginatedManagements"
                    :key="management.id"
                  ...
                  >
                    ...
                    <td class="px-6 py-4 text-center whitespace-nowrap">
                      <div class="flex items-center justify-center gap-2">
                        <button
                          @click="editManagement(management.id)"
                        ...
                        <button
                          @click="confirmDelete(management.id)"
            ...
            >
              <div>
                <p class="text-sm text-gray-600">
                  ...
                  of {{ filteredManagements.length }} results
                </p>
              </div>
...
const totalPages = computed(() => Math.ceil(filteredManagements.value.length / itemsPerPage));

const paginatedManagements = computed(() => {
  const startIndex = (currentPage.value - 1) * itemsPerPage;
  return filteredManagements.value.slice(startIndex, startIndex + itemsPerPage);
});
...
watch(managements, () => {
  filteredManagements.value = [...managements.value];
}, { immediate: true });

const editManagement = (id) => {
  router.push(`/dashboard/management/edit/${id}`);
};
...
const deleteManagement = async () => {
  ...
  try {
    ...
    managements.value = managements.value.filter(item => item.id !== deleteItemId.value);
    filteredManagements.value = managements.value;
    
    if (paginatedManagements.value.length === 0 && currentPage.value > 1) {
      currentPage.value--;
    }
  } catch (error) {
...
const getManagements = async () => {
  try {
    ...
    console.error("Error fetching management data:", error.message);
  }
};

onMounted(getManagements);
</script>