      ...
      <div class="-m-1.5 overflow-x-auto">
        <div class="p-1.5 min-w-full inline-block align-middle">
          ...
          >
            ...
            >
              <div>
                <h2 class="text-2xl font-semibold text-gray-800">Content Data</h2>
              </div>
            ...
            <div class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                  ...
                  >
                    <td class="px-6 py-4 w-40" v-html="content.icon"></td>
...
const paginatedContents = computed(() => {
  ...
  return filteredContents.value.slice(startIndex, startIndex + itemsPerPage);
});
...
const editContent = (id) => {
  router.push(`/dashboard/content/edit/${id}`);
};
