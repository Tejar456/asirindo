      ...
      <div class="-m-1.5 overflow-x-auto">
        <div class="p-1.5 min-w-full inline-block align-middle">
          ...
          >
            ...
            >
              <div>
                <h2 class="text-2xl font-semibold text-gray-800">Hero Data</h2>
              </div>
            ...
            <div class="overflow-x-auto">
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                  ...
                  <tr v-if="paginatedHeroes.length === 0">
            ...
            >
              <div>
                <p class="text-sm text-gray-600">
                  ...
                  to
                  {{
                    Math.min(currentPage * itemsPerPage, filteredHeroes.length)
                  }}
                  of {{ filteredHeroes.length }} results
                </p>
              </div>
...
const totalPages = computed(() =>
  Math.ceil(filteredHeroes.value.length / itemsPerPage)
);

const paginatedHeroes = computed(() => {
  const startIndex = (currentPage.value - 1) * itemsPerPage;
  return filteredHeroes.value.slice(startIndex, startIndex + itemsPerPage);
});
...
const editHero = (id) => {
  router.push(`/dashboard/hero/edit/${id}`);
};
...
const deleteHero = async () => {
  ...
  try {
    ...
    if (paginatedHeroes.value.length === 0 && currentPage.value > 1) {
      currentPage.value--;
    }
  } catch (error) {
