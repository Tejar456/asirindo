...
<template>
  <!-- Title -->
  <div
    class="h-[30vh] w-full relative mb-5 shadow-md flex items-center justify-center"
  >
    <div>
      <div v-if="loading">
        <div
      ...
      <div v-else>
        ...
        >
          ...
          >
            <nuxt-link to="/" class="text-white hover:text-blue-100"
              >Home</nuxt-link
            >
            >
            <nuxt-link to="/news" class="text-blue-400">News</nuxt-link>
          </h4>
        </div>
      </div>
    </div>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <!-- Card -->
      <a
        class="group flex flex-col focus:outline-none border-2 border-slate-400 rounded-2xl p-4 hover:border-yellow-400 transition-all duration-300 hover:shadow-lg"
        href="/news/detail"
      >
