            ...
            <div class="container mx-auto px-4">
                ...
                <div class="flex flex-col md:flex-row items-center md:items-start justify-center">
                    ...
                    <div
                        ...
                        <div class="block relative  transform transition-all duration-300 
                                bg-white border-2 border-slate-200 rounded-xl shadow-lg p-4
                                flex-col items-center hover:border-yellow-400 hover:scale-105
                                aspect-square" data-aos="fade-right" data-aos-delay="200">
                            <div class="w-full h-full flex flex-col items-center justify-center ">
                                ...
                                <h5
                                    class="mb-2 text-yellow-500 text-2xl  md:text-3xl font-bold tracking-tight text-center">
                                    {{ vidio }}
                                </h5>
                                <p
                                    class="text-md md:text-lg text-center font-bold tracking-wide text-slate-700 uppercase">
                                    VIDEO
                                </p>
                            </div>
                        </div>

                        <div class="block relative overflow-hidden transform transition-all duration-300 
                                bg-white border-2 border-slate-200 rounded-xl shadow-lg p-4
                                flex-col items-center hover:border-yellow-400 hover:scale-105
                                 aspect-square" data-aos="fade-right" data-aos-delay="300">
                            <div class="w-full h-full flex flex-col items-center justify-center ">
                                <div class="mb-4 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-8">
                        ...
                        <div class="block relative overflow-hidden transform transition-all duration-300 
                                bg-white border-2 border-slate-200 rounded-xl shadow-lg p-4
                                flex-col items-center hover:border-yellow-400 hover:scale-105
                                 aspect-square" data-aos="fade-right" data-aos-delay="400">
                            <div class="w-full h-full flex flex-col items-center justify-center ">
                                <div class="mb-4 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-8">
                        ...
                        <div class="block relative overflow-hidden transform transition-all duration-300 
                                bg-white border-2 border-slate-200 rounded-xl shadow-lg p-4
                                flex-col items-center hover:border-yellow-400 hover:scale-105
                                 aspect-square" data-aos="fade-right" data-aos-delay="600">
                            <div class="w-full h-full flex flex-col items-center justify-center ">
                                <div class="mb-4 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor" class="size-8">
