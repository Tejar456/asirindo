          ...
          <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-4 md:gap-8 max-w-7xl p-8 mx-auto">
              ...
              <div
                ...
                <div class="flex justify-center py-4">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" class="w-10 h-10">
                    <path fill="#4F46E5" strokeLinecap="round" strokeLinejoin="round"
            ...
            <div data-aos="fade-up">
              <div
                ...
                <div class="flex justify-center py-4">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" class="w-10 h-10">
                    <path fill="#059669" strokeLinecap="round" strokeLinejoin="round"
            ...
            <div data-aos="fade-up">
              <div
                ...
                <div class="flex justify-center py-4">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" class="w-10 h-10">
                    <path fill="#7C3AED" strokeLinecap="round" strokeLinejoin="round"
            ...
            <div data-aos="fade-up">
              <div
                ...
                <div class="flex justify-center py-4">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="1.5" class="w-10 h-10">
                    <path fill="#DC2626" strokeLinecap="round" strokeLinejoin="round"
